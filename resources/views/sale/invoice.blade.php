            ...
            <tbody>
                ...
                <?php 
                    ...
                    if($product_sale_data->variant_id) {
                        ...
                        $product_name = $lims_product_data->size != "" ? $lims_product_data->name."(".$lims_product_data->size.")" : $lims_product_data->name;
                    ...
                    elseif($product_sale_data->product_batch_id) {
                        ...
                        $product_name = $lims_product_data->size != "" ? $lims_product_data->name."(".$lims_product_data->size.")" : $lims_product_data->name;
                        $product_name .= ' ['.trans("file.Batch No").':'.$product_batch_data->batch_no.']';
                    }
                    else
                        $product_name = $lims_product_data->size != "" ? $lims_product_data->name."(".$lims_product_data->size.")" : $lims_product_data->name;
